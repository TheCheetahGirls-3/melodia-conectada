    ...
    methods: {
        ...
        guardarCliente() {
            ...
            if (this.latitud != 0 && this.longitud != 0) {
                ...
                axios
                    .post(
                        "http://localhost:80/melodia-conectada/app2/public/api/cliente",
                        {
                    ...
                    .then((response) => {
                        ...
                        if (me.usuario.id_tipo_usuario === 2) {
                            ...
                            axios.post('http://localhost:80/melodia-conectada/app2/public/api/local', {
                                    id_usuario: me.usuario.id_usuario,
                            });
                        ...
                        window.location.href =
                            "http://localhost:80/melodia-conectada/app2/public/index";
                    })
                    .catch((error) => {
